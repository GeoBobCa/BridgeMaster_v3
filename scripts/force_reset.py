...
try:
    with open(TARGET_FILE, "w", encoding="utf-8") as f:
        f.write(DEALER_BLOCK)
        f.write(HEARTS_BLOCK)
        f.write(HEARTS_REBIDS_BLOCK)
        f.write(NT_BLOCK)
        f.write(SPADES_BLOCK)
    print(f"✅ Success! File written. Size: {TARGET_FILE.stat().st_size} bytes.")
